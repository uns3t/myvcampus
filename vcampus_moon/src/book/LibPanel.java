...
//		final BookinfPanel bookinfPanel = new BookinfPanel();
		...
		//	bookinfPanel.setBackground(Color.white);
			...
			final SelectButton jb1 = new SelectButton("首    页");
			final SelectButton jb2 = new SelectButton("图书信息");
			final SelectButton jb3 = new SelectButton("搜索图书");
			if (admin == 1)
				jb3.setText("管理图书");
			final SelectButton jb4 = new SelectButton("个人记录");
