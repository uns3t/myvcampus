...
public class LibPanel extends JFrame {
	...
	final LibAdmin personalPanel;
	final BookInf bookinfPanel ;
	...
	public LibPanel(ClientThread thread) {

		mthread=thread;
		homePanel = new HomePanel();
		personalPanel = new LibAdmin(mthread);
		bookinfPanel = new BookInf(mthread);
		...
		final PButton jb4 = new PButton("管理图书");
		//if (admin == 1)
			//jb4.setText("管理图书");
		final PButton jb3 = new PButton("书籍信息");
